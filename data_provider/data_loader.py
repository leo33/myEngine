...
class Dataset_FRED_day(Dataset):
    ...
    def __read_data__(self):
        ...
        border1s = [
            0,                                # train
            12 * 30 - self.seq_len,           # test
            12 * 30 + 4 * 30 - self.seq_len]  # validate
        # ... to
        border2s = [
            12 * 30,                          # train
            12 * 30 + 4 * 30,                 # test
...
class Dataset_FRED_month(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='FREDm1.csv',
                 target='OT', scale=True, timeenc=0, freq='h', percent=100,
                 seasonal_patterns=None):
    ...
    def __read_data__(self):
        ...
        border1s = [
            0,                                # train
            12 * 10 - self.seq_len,           # test
            12 * 10 + 4 * 10 - self.seq_len]  # validate
        # ... to
        border2s = [
            12 * 10,                          # train
            12 * 10 + 4 * 10,                 # test
